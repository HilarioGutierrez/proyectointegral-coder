...
const SingupSuccess = () => {
    return (
        <div className='flex flex-col min-h-screen justify-center bg-dark'>
            ...
            <h5 className='mx-auto mt-4 text-3xl text-light text-center font-semibold font-style: italic font'>Thank you for Regsieter. Check your email and confirm user</h5>
